  ...
  <div class="container">
    ...
    <ul class="navbar-nav" align="left">
      ...
      <li class="nav-item ml-3">
        <a class="nav-link text-white" href="<?php echo base_url('Acara/add')?>" id="active">Buat Event</a>
      </li>
      <li class="nav-item ml-3">
    ...
    <div class="dropdown">
      <button type="button" class="btn btn-warning dropdown-toggle float-right" data-toggle="dropdown">
        <img src="<?php echo base_url('asset/img/user.png')?>" style="height: 27px;"> AMCC
      </button>
      <div class="dropdown-menu ">
        <h5 class="dropdown-header">Penyelenggara</h5>
        <a class="dropdown-item" href="manage_event">Manage Events</a>
        <a class="dropdown-item" href="<?php echo base_url('profil')?>">Organizer Profile</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" href="<?php echo base_url('Home/index')?>">Log out<img src="<?php echo base_url('asset/img/log_out.png')?>" class="float-right pt-1"></a>
      </div>
    </div>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <div style="position: absolute;
        ...
        <a href="<?php echo base_url('Acara/add')?>" type="button" class="btn btn-outline-warning text-center" style="width: 150px; height: 50px; font-size: 20px;">Buat Event</a>
      </div>
    </div>
    <div class="carousel-item">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="float-left">Maaf karena Anda sebagai Penyelenggara, maka tidak dapat melakukan pendaftaran event.</p><br><br>
      </div>
    </div>
  </div>
</div>
